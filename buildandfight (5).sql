...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 28 fév. 2023 à 08:12
...
--
-- Structure de la table `profil_player`
--

DROP TABLE IF EXISTS `profil_player`;
CREATE TABLE IF NOT EXISTS `profil_player` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_player` int NOT NULL,
  `grade` int NOT NULL,
  `img` text NOT NULL,
...
--
-- Déchargement des données de la table `profil_player`
--

INSERT INTO `profil_player` (`id`, `id_player`, `grade`, `img`) VALUES
(1, 1, 8, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTX46G90mH8TaQn__1g0t5E0Iz0sRFzp-0WZSxC2yz&s');
...
CREATE TABLE IF NOT EXISTS `ressource_player` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_player` int NOT NULL,
  `gold` int NOT NULL DEFAULT '15000',
...
INSERT INTO `ressource_player` (`id`, `id_player`, `gold`, `petrol`, `nourriture`, `electriciter`, `plutonium`, `berium`, `uranium`, `diesel`, `sp98`, `sp95`) VALUES
(1, 1, 150202163, 85528, 15000, 15000, 15000, 15000, 15000, 15000, 15000, 15000),
...
INSERT INTO `users` (`id`, `pseudo`, `nom`, `prenom`, `mdp`, `date`, `date_derniere_co`, `email`) VALUES
(1, 'florian', 'floo', 'florian', '$2y$10$Ukw/I3DqUTcVagONNVdbceGOpD8PPh2se62vuq3kW1cXkjDztSsue', '2023-02-22 17:54:14', 1677531238, ''),
